...
function PANEL:Init()
	...
	AddRowToScroll("celadon0451","GoldBrick","HazmatHanger")
	AddRowToScroll("M.D.","FriendlyGarry","Chloez_z")
	AddRowToScroll("Ozzy","FerfoCurse","g3")
	AddRowToScroll("","WaterInspector","")
